    ...
    <div className="min-h-screen bg-indigo-950   font-inter text-gray-50 antialiased">
      ...
      >
        ...
        <nav className="relative z-10 p-6 flex justify-between items-center max-w-7xl mx-auto">
          ...
          <ul className="hidden md:flex space-x-8">
            {["About", "Profile", "Events", "Blog", "Contacts"].map((item) => (
              <li key={item}>
                ...
                <a
                  href={
                    item === "Profile" ? "/profile" : `#${item.toLowerCase()}`
                  }
          ...
          <div className="flex space-x-4">
            <a
              href="#"
              className="text-gray-50 hover:text-indigo-300 transition duration-300 ease-in-out text-xl rounded-full p-2"
            >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <p
            className="text-xl md:text-2xl text-gray-300 mb-10 animate-fadeInUp"
            style={{ animationDelay: "0.2s" }}
          >
            HIGHFIVE MILES Running Club
          </p>
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
            <button
              onClick={() => navigate("/login")}
              className="bg-cyan-600 hover:bg-indigo-800 text-white font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105 animate-bounceIn"
            ...
            <button
              ...
              className="bg-transparent border-2 border-indigo-300 hover:border-white text-indigo-300 hover:text-white font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105 animate-bounceIn"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center md:space-x-12">
            ...
            <div className="md:w-1/2 text-center md:text-left">
              <h2
                className="text-4xl font-extrabold text-grey-900 mb-6 animate-fadeInUp"
                style={{ animationDelay: "0.7s" }}
              >
                ABOUT US
              </h2>{" "}
              ...
              >
                {" "}
                {/* Added animation */}
                Established in 2023, HIGHFIVE MILES is a community-driven
                initiative passionately crafted for the vibrant running spirit
                of India. We believe in uniting runners from all walks of life,
                from the bustling streets of Mumbai to the serene landscapes of
                the Himalayas. Our aim is to foster a culture of fitness,
                camaraderie, and personal achievement across every city and
                village.
              </p>
              <p
              ...
              >
                {" "}
                {/* Added animation */}
                HIGHFIVE MILES provides a platform for training programs
                tailored for Indian conditions, organizes local runs and events
                that celebrate our diverse heritage, and creates a supportive
                network for every stride you take. Join us in building a
                healthier, happier India, one mile at a time.
              </p>
              <p
                className="text-sm text-gray-600 mb-6 animate-fadeInUp"
              ...
              <div
                className="flex justify-center md:justify-start space-x-4 mb-8 animate-fadeInUp"
              ...
              >
                ...
                <a
                  href="#"
                  className="text-gray-900 hover:text-blue-900 transition duration-300 ease-in-out text-2xl rounded-full p-2"
                >
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a
                  href="#"
                  className="text-gray-900 hover:text-purple-500 transition duration-300 ease-in-out text-2xl rounded-full p-2"
                >
                  <i className="fab fa-instagram"></i>
                </a>
                <a
                  href="#"
                  className="text-gray-900 hover:text-rose-500 transition duration-300 ease-in-out text-2xl rounded-full p-2"
                >
                  <i className="fab fa-youtube"></i>
                </a>
              </div>
              {/* Learn More Button */}
              <button
                className="bg-rose-600 hover:bg-rose-700 text-white font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105 animate-bounceIn"
      ...
      <section id="events" className="relative py-16 bg-gray-800 text-gray-50">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${backgroundImageEvents})`,
            animationDelay: "0.9s",
            opacity: "0.3",
          }}
        ></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-white mb-12 text-center animate-fadeInUp">
            UPCOMING EVENTS
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div
              className="bg-gray-700 rounded-lg shadow-xl overflow-hidden border border-gray-600 flex flex-col md:flex-row animate-fadeInUp"
            ...
            <div
              className="bg-gray-700 rounded-lg shadow-xl overflow-hidden border border-gray-600 flex flex-col md:flex-row-reverse animate-fadeInUp"
              style={{ animationDelay: "0.6s" }}
            >
              {/* Increased image height to h-64 */}
              <img
                src={event2}
                alt="Delhi Half Marathon"
                className="w-full md:w-1/2 h-64 md:h-auto object-cover"
              />
              <div className="p-6 md:w-1/2 flex flex-col justify-center">
            ...
            >
              ...
              <img
                src={event4}
                alt="Himalayan Ultra Trail"
                className="w-full md:w-1/2 h-64 md:h-auto object-cover"
              />
              <div className="p-6 md:w-1/2 flex flex-col justify-center">
                <p className="text-gray-300 text-sm mb-1">June 10-12, 2026</p>
                <h3 className="text-2xl font-bold text-white mb-3">
                  Himalayan Ultra Trail
                </h3>
                <p className="text-gray-400 text-sm mb-4">
                  Adventure starts at 5:00 AM
                </p>
                <button className="bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-2 px-6 rounded-full shadow-md transition duration-300 ease-in-out self-start">
                  LEARN MORE
                </button>
      ...
      <section
        id="partners"
        className="relative py-64 text-gray-900"
        style={{
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-3/4 text-center md:text-left mb-8 md:mb-0">
            <h2
              className="text-4xl md:text-5xl font-extrabold mb-4 text-gray-900 animate-fadeInUp"
              style={{ animationDelay: "0.3s" }}
            >
              WANT TO PARTNER WITH US?
            </h2>
            <p
              className="text-lg leading-relaxed text-gray-800 animate-fadeInUp"
              style={{ animationDelay: "0.6s" }}
            >
              We are always looking to add to our team of partners and better
              enhance our members' experiences with the club. If you'd like to
              join us in this mission, contact us today!
            </p>
          </div>
          <div
            className="md:w-1/4 flex justify-center md:justify-end animate-bounceIn"
            style={{ animationDelay: "0.9s" }}
          >
      ...
      <section id="blog" className="py-16 bg-gray-900 text-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-extrabold text-emerald-500 mb-12 text-center animate-fadeInUp">
            BLOG
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Blog Post 1 */}
            <div
              className="bg-gray-800 rounded-lg shadow-xl overflow-hidden animate-fadeInUp"
              style={{ animationDelay: "0.3s" }}
            >
              <img
                src={event1}
              ...
              <div className="p-6">
                <p className="text-emerald-400 text-sm font-semibold mb-1">
                  Creative Process | September 29, 2023
                </p>
                <h3 className="text-xl font-bold text-white mb-2">
                  How to Hire the Best Employees to Your Company?
                </h3>
                <p className="text-gray-400 text-sm">
                  Today we'd like to introduce you to Debbie Mercer. Debbie has
                  a lot to say about how affection with sports can...
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-6">
                <p className="text-emerald-400 text-sm font-semibold mb-1">
                  Creative Process | September 26, 2023
                </p>
                <h3 className="text-xl font-bold text-white mb-2">
                  How to Double Weight Loss Efforts in Just 15 Minutes a Day
                </h3>
                <p className="text-gray-400 text-sm">
                  It's quite normal to gain weight in winter. Colder weather
                  makes us want to stay at home and do less calorie-consuming...
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-6">
                <p className="text-emerald-400 text-sm font-semibold mb-1">
                  Creative Process | September 22, 2023
                </p>
                <h3 className="text-xl font-bold text-white mb-2">
                  Top 5 Easy Tips to Healthier Lifestyle
                </h3>
                <p className="text-gray-400 text-sm">
                  A healthy diet can bring you better results! Get to know how
                  to improve your results through foods that are...
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        id="contacts"
        className="relative py-16 text-gray-50"
        style={{
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-start md:space-x-12">
            ...
            <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
              <h2
                className="text-4xl font-extrabold text-rose-500 mb-6 animate-fadeInUp"
                style={{ animationDelay: "0.3s" }}
              >
                CONTACTS
              </h2>
              <p
                className="text-gray-300 leading-relaxed mb-6 animate-fadeInUp"
                style={{ animationDelay: "0.6s" }}
              >
                Thank you for your interest in HIGHFIVE MILES. Please email or
                call us if you need more information. We appreciate your
                feedback.
              </p>

              <div
                className="space-y-4 text-left inline-block animate-fadeInUp"
                style={{ animationDelay: "0.9s" }}
              >
                <div>
            ...
            <div
              className="md:w-1/2 w-full bg-gray-800 p-8 rounded-lg shadow-xl animate-fadeInUp"
              style={{ animationDelay: "0.6s" }}
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <a
                href="#"
                className="text-gray-300 hover:text-pink-500 transition duration-300 text-xl"
              >
                <i className="fab fa-facebook-f"></i>
              </a>
              <a
